 ...
 * @author Ganzo
 */
public class FrmBajasTutorados extends javax.swing.JFrame {

    ConexionBD con = new ConexionBD ("tutorado");
    /**
     * Creates new form FrmBajasTutorados
     */
    public FrmBajasTutorados() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Bajas de Tutorados");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        String clave = txtClaveTutorado.getText().toUpperCase().trim();
        int op = JOptionPane.showConfirmDialog(this, "Desea eliminar este registro?");
        if (op == JOptionPane.OK_OPTION) {
            String enunciadSQL = "DELETE FROM tutorados WHERE clavetutorado='" + clave + "'";
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBajasTutorados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBajasTutorados().setVisible(true);
            }
        });
    }
